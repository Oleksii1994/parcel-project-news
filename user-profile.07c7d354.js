 ...
 */
(0,s("ix4Jr").registerVersion)("firebase","9.18.0","app")})),s.register("ix4Jr",(function(e,n){t(e.exports,"_registerComponent",(function(){return y})),t(e.exports,"_getProvider",(function(){return v})),t(e.exports,"SDK_VERSION",(function(){return _})),t(e.exports,"initializeApp",(function(){return k})),t(e.exports,"getApp",(function(){return C})),t(e.exports,"registerVersion",(function(){return I}));var i=s("4a6xH"),r=s("7vF8m"),o=s("ffjl9"),a=s("cCiiD");o=s("ffjl9");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht{static empty(){return new Ht(new qt(null))}constructor(e){this.writeTree_=e}}function jt(e,t,n){if(_e(t))return new Ht(new qt(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const r=i.path;let s=i.value;const o=ke(r,t);return s=s.updateChild(o,n),new Ht(e.writeTree_.set(r,s))}{const i=new qt(n),r=e.writeTree_.setTree(t,i);return new Ht(r)}}}function Xt(e,t,n){let i=e;return F(n,((e,n)=>{i=jt(i,xe(t,e),n)})),i}function Kt(e,t){if(_e(t))return Ht.empty();{const n=e.writeTree_.setTree(t,new qt(null));return new Ht(n)}}function Yt(e,t){return null!=Gt(e,t)}function Gt(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(ke(n.path,t)):null}function Vt(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Qe,((e,n)=>{t.push(new De(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new De(e,n.value))})),t}function Qt(e,t){if(_e(t))return e;{const n=Gt(e,t);return new Ht(null!=n?new qt(n):e.writeTree_.subtree(t))}}function Jt(e){return e.writeTree_.isEmpty()}function Zt(e,t){return $t(fe(),e.writeTree_,t)}function $t(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,r)=>{".priority"===t?((0,o.assert)(null!==r.value,"Priority writes must always be leaf nodes"),i=r.value):n=$t(xe(e,t),r,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(xe(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
